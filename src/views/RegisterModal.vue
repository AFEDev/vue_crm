  ...
  <form class="card auth-card" @submit.prevent="submitHandler">
    <div class="card-content">
      ...
      <div class="input-field">
        ...
        <small class="error" v-for="error of v$.email.$errors" :key="error.$uid"
      ...
      <div class="input-field">
        ...
        <small class="error" v-for="error of v$.password.$errors" :key="error.$uid"
          ><br />{{ error.$message }}</small
        >
      </div>
      <div class="input-field">
      ...
      <p>
        <label>
          ...
          <small class="error" v-for="error of v$.agree.$errors" :key="error.$uid"
            ><br />{{ error.$message }}</small
          >
        </label>
      </p>
...
export default {
  mixins: [titleMixin],
  title() {
    return this.$filters.localizeFilter("Register");
  },
  name: "RegisterModel",
  setup() {
    return {
